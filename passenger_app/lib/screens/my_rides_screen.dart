      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: const Text(
              'Your ride bookings and requests',
              style: TextStyle(
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          _selectedStatus == 'all' ? 'No rides yet' : 'No ${_getStatusDisplayText(_selectedStatus).toLowerCase()} rides',
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // Driver info for accepted/in-progress rides
